...
import Project3D from "./_components/Project3D";
    ...
    <>
      {loading ? (
        ...
        <main className="min-h-screen text-white selection:bg-cyan-500/30 overflow-x-hidden relative animate-fade-in-up font-sans">
          ...
          {/* BACKGROUND LAYERS - These sit at z-0 or below */}
          {/* If Atmosphere is the culprit, the content below will now sit ON TOP of it */}
          ...
          {/* CONTENT LAYER - Explicitly lifted to z-10 to sit ABOVE the atmosphere/fog */}
          <div className="relative z-10">
            ...
            <section id="hero" className="relative min-h-screen flex flex-col md:flex-row justify-center items-center px-4 gap-8 md:gap-16 pt-20">
              ...
              <div className="text-center md:text-left space-y-6 z-10 max-w-2xl">
                ...
                <p className="text-blue-200/80 text-lg md:text-xl font-light leading-relaxed font-display tracking-wide">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start pt-8">
                  <a href={profile.resumeLink} target="_blank" className="px-8 py-4 bg-white text-black font-bold font-display tracking-widest uppercase rounded hover:bg-cyan-400 transition-all hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center gap-2 justify-center">
                      Access Resume
                  </a>
